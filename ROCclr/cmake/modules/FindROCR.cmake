...
find_path(FIND_ROCR_INCLUDES hsa.h HINTS /opt/rocm/include /opt/rocm/hsa/include $ENV{ROCR_DIR}/src/inc PATH_SUFFIXES hsa)
find_library(FIND_ROCR_LIBRARIES hsa-runtime64 HINTS $ENV{ROCR_DIR}/src/build /opt/rocm/lib /opt/rocm/hsa/lib)
